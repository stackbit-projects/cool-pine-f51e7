...
import { getComponent } from '@stackbit/dist/components-registry';
import { mapStylesToClassNames as mapStyles } from '@stackbit/dist/utils/map-styles-to-class-names';
